  ...
  return (
    <div className="svg-container flex items-center">
      <svg className="animated-logo" width={props.width} height={props.width} viewBox="0 0 205 166" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path ref={(el) => { circlesRef.current[3] = el }} className="circle" d="M31.7705 13.2409C31.7705 5.92816 25.8423 0 18.5295 0C11.2167 0 5.28857 5.92816 5.28857 13.2409C5.28857 20.5537 11.2167 26.4819 18.5295 26.4819C25.8423 26.4819 31.7705 20.5537 31.7705 13.2409Z" fill="white"/>
        <path d="M33.0595 33.0961C14.8329 33.0961 0 47.929 0 66.1555V98.9671H66.1189V66.1555C66.1189 47.929 51.286 33.0961 33.0595 33.0961ZM53.3832 66.1555C53.3832 67.7761 52.0677 69.0725 50.4662 69.0725H15.6527C14.0322 69.0725 12.7357 67.757 12.7357 66.1555C12.7357 64.535 14.0512 63.2385 15.6527 63.2385H50.4662C52.0868 63.2385 53.3832 64.554 53.3832 66.1555Z" fill="white"/>
        ...
        <path d="M174.226 63.221H204.235V33.0786H171.424C153.197 33.0786 138.364 47.9115 138.364 66.138C138.364 84.3646 153.197 99.1976 171.424 99.1976H204.235V69.0551H174.226C172.606 69.0551 171.309 67.7395 171.309 66.138C171.309 64.5175 172.625 63.221 174.226 63.221Z" fill="white"/>
        <path d="M103.795 49.0091L47.676 123.051L71.6374 141.212L127.757 67.1704L103.795 49.0091Z" fill="white"/>
      </svg>
    </div>
  );
};
